...
const CardInfo: FC<CardInfo> = ({ data, textColor }) => {
  return <Stack direction="column">
    <Text color={textColor} fontWeight="500">{data.title}</Text>
    ...
    <Flex direction="row" alignItems="center" justifyContent={'space-between'}>
      <HStack gap={7}>
        <Stack direction="row" alignItems="center">
          ...
          <Text fontSize="sm" color={textColor}>{data.totalLikes}</Text>
        </Stack>
        <Stack direction="row" alignItems="center">
          <FaRegComment color={textColor} />
          <Text fontSize="sm" color={textColor}>{data.totalComments}</Text>
        </Stack>
        <Stack direction="row" alignItems="center">
